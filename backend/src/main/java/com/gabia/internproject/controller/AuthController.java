...
public class AuthController {
    ...
    @ApiOperation(value = "인증요청", notes = "인증요청")
     public ResponseEntity<?> getToken(HttpServletResponse response,@PathVariable String serviceProvider) {
...
//                .scope("email")
        ...
        return ResponseEntity.ok(new ApiResponse(true,authUrl+"_____________"+authUrl2));
